...
//  //string Array 
let ArrayStudents = ["bilawal", "zeeshan ", "imran ", "babar ",];
// Number Array 
let NumberStudent = [0, 1, 2, 3, 4, 5];
// mixed Array 
let mixedArray = [1, 2, 3, "Hellow "];
console.log(`Array students :${ArrayStudents}
 Number Student : ${NumberStudent} 
 Mixed Array :${mixedArray}`);
//  length Array 
let friends = ['faraz', 'safeer', 'waqar', 'Aijaz'];
...
// update  Array 
let schoolTecher = [" Ibrahim ", "Mehak", "Shakeel", "Zeeshan"];
...
let sliceArray = ["Amal", "Afra", "Asma", "Aiza", "Aaliyah", "Afaaf"];
...
let spliceArray = ["Fatima", "Aiza", "Iqra ", "Muskaan ", "dua "];
...
// concat array
let concatarray1 = ['mehake ', 'Alina ', 'mehwish '];
let concatArray2 = ['Nayab', 'Alisha '];
